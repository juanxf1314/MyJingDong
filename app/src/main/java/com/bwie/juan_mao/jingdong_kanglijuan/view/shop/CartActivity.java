...
public class CartActivity extends BaseActivity<CartPresenter> implements ICartView {
    ...
    protected void initData() {
        // 设置弹框
        View view = View.inflate(this, R.layout.dialog_delete_cart, null);
        ...
        rvRecommend.setNestedScrollingEnabled(false);
        recommendShopAdapter = new RecommendShopAdapter(this, list);
        ...
        recommendShopAdapter.setOnItemClickListener(new RecommendShopAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                Intent intent = new Intent(CartActivity.this, ShopWebActivity.class);
        ...
        // 商家的列表
        adapter = new ShopperAdapter(this, cartList);
        // 添加一级条目（商家）状态发生变化时
    ...
    @OnClick({R.id.txt_edit_complete, R.id.img_msg, R.id.btn_account, R.id.txt_delete})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.txt_edit_complete:
                ...
                break;
            case R.id.img_msg:
                Toast.makeText(this, "此功能尚在开发中~", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.btn_account:
                ...
                if (listBean.size() != 0) {
                    ...
                    Toast.makeText(this, "请选中商品再下单", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
