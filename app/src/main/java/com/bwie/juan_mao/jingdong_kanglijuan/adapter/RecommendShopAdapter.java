...
public class RecommendShopAdapter extends RecyclerView.Adapter<RecommendShopAdapter.MyViewHolder> {
    private Context context;
    private List<RecommendBean.DataBean.ListBean> list;

    public RecommendShopAdapter(Context context, List<RecommendBean.DataBean.ListBean> list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.item_shop_recommend, null);
